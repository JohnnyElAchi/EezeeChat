...
class First : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val CallButton = this.findViewById<View>(R.id.callgirl)
        CallButton.setOnClickListener {
            val intent = Intent(this, CallGirlActivity::class.java)
        ...
        menuButton.setOnClickListener { v ->
            ...
            val favoriteFragment =
                intent.getSerializableExtra("favoriteFragment") as? FavoriteFragment
